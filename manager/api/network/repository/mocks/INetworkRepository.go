...
// INetworkRepository is an autogenerated mock type for the INetworkRepository type
type INetworkRepository struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, _a1
func (_m *INetworkRepository) Create(ctx context.Context, _a1 *network.NetworkModel) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *network.NetworkModel) error); ok {
		r0 = rf(ctx, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *INetworkRepository) Delete(ctx context.Context, name string) error {
...
func (_m *INetworkRepository) List(ctx context.Context, filterParams *dto.ListNetworkReq) ([]*network.NetworkModel, error) {
...
// NewINetworkRepository creates a new instance of INetworkRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewINetworkRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *INetworkRepository {
