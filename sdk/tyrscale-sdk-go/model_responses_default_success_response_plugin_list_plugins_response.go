...
// checks if the ResponsesDefaultSuccessResponsePluginListPluginsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesDefaultSuccessResponsePluginListPluginsResponse{}

// ResponsesDefaultSuccessResponsePluginListPluginsResponse struct for ResponsesDefaultSuccessResponsePluginListPluginsResponse
type ResponsesDefaultSuccessResponsePluginListPluginsResponse struct {
	Code *int32 `json:"code,omitempty"`
	Data *PluginListPluginsResponse `json:"data,omitempty"`
...
func NewResponsesDefaultSuccessResponsePluginListPluginsResponse() *ResponsesDefaultSuccessResponsePluginListPluginsResponse {
	this := ResponsesDefaultSuccessResponsePluginListPluginsResponse{}
	return &this
}
...
func (o *ResponsesDefaultSuccessResponsePluginListPluginsResponse) GetData() PluginListPluginsResponse {
	if o == nil || IsNil(o.Data) {
		var ret PluginListPluginsResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given PluginListPluginsResponse and assigns it to the Data field.
...
func (o ResponsesDefaultSuccessResponsePluginListPluginsResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponsesDefaultSuccessResponsePluginListPluginsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesDefaultSuccessResponsePluginListPluginsResponse struct {
	value *ResponsesDefaultSuccessResponsePluginListPluginsResponse
	isSet bool
}

func (v NullableResponsesDefaultSuccessResponsePluginListPluginsResponse) Get() *ResponsesDefaultSuccessResponsePluginListPluginsResponse {
	return v.value
}

func (v *NullableResponsesDefaultSuccessResponsePluginListPluginsResponse) Set(val *ResponsesDefaultSuccessResponsePluginListPluginsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesDefaultSuccessResponsePluginListPluginsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesDefaultSuccessResponsePluginListPluginsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesDefaultSuccessResponsePluginListPluginsResponse(val *ResponsesDefaultSuccessResponsePluginListPluginsResponse) *NullableResponsesDefaultSuccessResponsePluginListPluginsResponse {
	return &NullableResponsesDefaultSuccessResponsePluginListPluginsResponse{value: val, isSet: true}
}

func (v NullableResponsesDefaultSuccessResponsePluginListPluginsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesDefaultSuccessResponsePluginListPluginsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
