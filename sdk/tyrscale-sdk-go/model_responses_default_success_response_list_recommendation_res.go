...
// checks if the ResponsesDefaultSuccessResponseListRecommendationRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesDefaultSuccessResponseListRecommendationRes{}

// ResponsesDefaultSuccessResponseListRecommendationRes struct for ResponsesDefaultSuccessResponseListRecommendationRes
type ResponsesDefaultSuccessResponseListRecommendationRes struct {
	Code *int32 `json:"code,omitempty"`
	Data *ListRecommendationRes `json:"data,omitempty"`
...
func NewResponsesDefaultSuccessResponseListRecommendationRes() *ResponsesDefaultSuccessResponseListRecommendationRes {
	this := ResponsesDefaultSuccessResponseListRecommendationRes{}
	return &this
}
...
// SetData gets a reference to the given ListRecommendationRes and assigns it to the Data field.
...
func (o ResponsesDefaultSuccessResponseListRecommendationRes) MarshalJSON() ([]byte, error) {
...
func (o ResponsesDefaultSuccessResponseListRecommendationRes) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesDefaultSuccessResponseListRecommendationRes struct {
	value *ResponsesDefaultSuccessResponseListRecommendationRes
	isSet bool
}

func (v NullableResponsesDefaultSuccessResponseListRecommendationRes) Get() *ResponsesDefaultSuccessResponseListRecommendationRes {
	return v.value
}

func (v *NullableResponsesDefaultSuccessResponseListRecommendationRes) Set(val *ResponsesDefaultSuccessResponseListRecommendationRes) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesDefaultSuccessResponseListRecommendationRes) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesDefaultSuccessResponseListRecommendationRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesDefaultSuccessResponseListRecommendationRes(val *ResponsesDefaultSuccessResponseListRecommendationRes) *NullableResponsesDefaultSuccessResponseListRecommendationRes {
	return &NullableResponsesDefaultSuccessResponseListRecommendationRes{value: val, isSet: true}
}

func (v NullableResponsesDefaultSuccessResponseListRecommendationRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesDefaultSuccessResponseListRecommendationRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
