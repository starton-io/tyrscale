...
// checks if the ResponsesCreatedSuccessResponseCreateRecommendationRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesCreatedSuccessResponseCreateRecommendationRes{}

// ResponsesCreatedSuccessResponseCreateRecommendationRes struct for ResponsesCreatedSuccessResponseCreateRecommendationRes
type ResponsesCreatedSuccessResponseCreateRecommendationRes struct {
	Code *int32 `json:"code,omitempty"`
	Data *CreateRecommendationRes `json:"data,omitempty"`
...
func NewResponsesCreatedSuccessResponseCreateRecommendationRes() *ResponsesCreatedSuccessResponseCreateRecommendationRes {
	this := ResponsesCreatedSuccessResponseCreateRecommendationRes{}
	return &this
}
...
func (o *ResponsesCreatedSuccessResponseCreateRecommendationRes) GetData() CreateRecommendationRes {
	if o == nil || IsNil(o.Data) {
		var ret CreateRecommendationRes
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given CreateRecommendationRes and assigns it to the Data field.
...
func (o ResponsesCreatedSuccessResponseCreateRecommendationRes) MarshalJSON() ([]byte, error) {
...
func (o ResponsesCreatedSuccessResponseCreateRecommendationRes) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesCreatedSuccessResponseCreateRecommendationRes struct {
	value *ResponsesCreatedSuccessResponseCreateRecommendationRes
	isSet bool
}

func (v NullableResponsesCreatedSuccessResponseCreateRecommendationRes) Get() *ResponsesCreatedSuccessResponseCreateRecommendationRes {
	return v.value
}

func (v *NullableResponsesCreatedSuccessResponseCreateRecommendationRes) Set(val *ResponsesCreatedSuccessResponseCreateRecommendationRes) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesCreatedSuccessResponseCreateRecommendationRes) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesCreatedSuccessResponseCreateRecommendationRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesCreatedSuccessResponseCreateRecommendationRes(val *ResponsesCreatedSuccessResponseCreateRecommendationRes) *NullableResponsesCreatedSuccessResponseCreateRecommendationRes {
	return &NullableResponsesCreatedSuccessResponseCreateRecommendationRes{value: val, isSet: true}
}

func (v NullableResponsesCreatedSuccessResponseCreateRecommendationRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesCreatedSuccessResponseCreateRecommendationRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
