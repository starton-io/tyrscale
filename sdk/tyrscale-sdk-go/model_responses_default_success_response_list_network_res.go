...
// checks if the ResponsesDefaultSuccessResponseListNetworkRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesDefaultSuccessResponseListNetworkRes{}

// ResponsesDefaultSuccessResponseListNetworkRes struct for ResponsesDefaultSuccessResponseListNetworkRes
type ResponsesDefaultSuccessResponseListNetworkRes struct {
	Code *int32 `json:"code,omitempty"`
	Data *ListNetworkRes `json:"data,omitempty"`
...
func NewResponsesDefaultSuccessResponseListNetworkRes() *ResponsesDefaultSuccessResponseListNetworkRes {
	this := ResponsesDefaultSuccessResponseListNetworkRes{}
	return &this
}
...
// SetData gets a reference to the given ListNetworkRes and assigns it to the Data field.
...
func (o ResponsesDefaultSuccessResponseListNetworkRes) MarshalJSON() ([]byte, error) {
...
func (o ResponsesDefaultSuccessResponseListNetworkRes) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesDefaultSuccessResponseListNetworkRes struct {
	value *ResponsesDefaultSuccessResponseListNetworkRes
	isSet bool
}

func (v NullableResponsesDefaultSuccessResponseListNetworkRes) Get() *ResponsesDefaultSuccessResponseListNetworkRes {
	return v.value
}

func (v *NullableResponsesDefaultSuccessResponseListNetworkRes) Set(val *ResponsesDefaultSuccessResponseListNetworkRes) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesDefaultSuccessResponseListNetworkRes) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesDefaultSuccessResponseListNetworkRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesDefaultSuccessResponseListNetworkRes(val *ResponsesDefaultSuccessResponseListNetworkRes) *NullableResponsesDefaultSuccessResponseListNetworkRes {
	return &NullableResponsesDefaultSuccessResponseListNetworkRes{value: val, isSet: true}
}

func (v NullableResponsesDefaultSuccessResponseListNetworkRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesDefaultSuccessResponseListNetworkRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
