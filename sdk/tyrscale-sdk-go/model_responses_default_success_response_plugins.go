...
// checks if the ResponsesDefaultSuccessResponsePlugins type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesDefaultSuccessResponsePlugins{}

// ResponsesDefaultSuccessResponsePlugins struct for ResponsesDefaultSuccessResponsePlugins
type ResponsesDefaultSuccessResponsePlugins struct {
...
func NewResponsesDefaultSuccessResponsePlugins() *ResponsesDefaultSuccessResponsePlugins {
	this := ResponsesDefaultSuccessResponsePlugins{}
	return &this
}
...
// SetData gets a reference to the given Plugins and assigns it to the Data field.
...
func (o ResponsesDefaultSuccessResponsePlugins) MarshalJSON() ([]byte, error) {
...
func (o ResponsesDefaultSuccessResponsePlugins) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesDefaultSuccessResponsePlugins struct {
	value *ResponsesDefaultSuccessResponsePlugins
	isSet bool
}

func (v NullableResponsesDefaultSuccessResponsePlugins) Get() *ResponsesDefaultSuccessResponsePlugins {
	return v.value
}

func (v *NullableResponsesDefaultSuccessResponsePlugins) Set(val *ResponsesDefaultSuccessResponsePlugins) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesDefaultSuccessResponsePlugins) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesDefaultSuccessResponsePlugins) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesDefaultSuccessResponsePlugins(val *ResponsesDefaultSuccessResponsePlugins) *NullableResponsesDefaultSuccessResponsePlugins {
	return &NullableResponsesDefaultSuccessResponsePlugins{value: val, isSet: true}
}

func (v NullableResponsesDefaultSuccessResponsePlugins) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesDefaultSuccessResponsePlugins) UnmarshalJSON(src []byte) error {
	v.isSet = true
