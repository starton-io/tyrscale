...
// checks if the ResponsesCreatedSuccessResponseCreateRouteRes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesCreatedSuccessResponseCreateRouteRes{}

// ResponsesCreatedSuccessResponseCreateRouteRes struct for ResponsesCreatedSuccessResponseCreateRouteRes
type ResponsesCreatedSuccessResponseCreateRouteRes struct {
	Code *int32 `json:"code,omitempty"`
	Data *CreateRouteRes `json:"data,omitempty"`
...
func NewResponsesCreatedSuccessResponseCreateRouteRes() *ResponsesCreatedSuccessResponseCreateRouteRes {
	this := ResponsesCreatedSuccessResponseCreateRouteRes{}
	return &this
}
...
// SetData gets a reference to the given CreateRouteRes and assigns it to the Data field.
...
func (o ResponsesCreatedSuccessResponseCreateRouteRes) MarshalJSON() ([]byte, error) {
...
func (o ResponsesCreatedSuccessResponseCreateRouteRes) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesCreatedSuccessResponseCreateRouteRes struct {
	value *ResponsesCreatedSuccessResponseCreateRouteRes
	isSet bool
}

func (v NullableResponsesCreatedSuccessResponseCreateRouteRes) Get() *ResponsesCreatedSuccessResponseCreateRouteRes {
	return v.value
}

func (v *NullableResponsesCreatedSuccessResponseCreateRouteRes) Set(val *ResponsesCreatedSuccessResponseCreateRouteRes) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesCreatedSuccessResponseCreateRouteRes) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesCreatedSuccessResponseCreateRouteRes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesCreatedSuccessResponseCreateRouteRes(val *ResponsesCreatedSuccessResponseCreateRouteRes) *NullableResponsesCreatedSuccessResponseCreateRouteRes {
	return &NullableResponsesCreatedSuccessResponseCreateRouteRes{value: val, isSet: true}
}

func (v NullableResponsesCreatedSuccessResponseCreateRouteRes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesCreatedSuccessResponseCreateRouteRes) UnmarshalJSON(src []byte) error {
	v.isSet = true
