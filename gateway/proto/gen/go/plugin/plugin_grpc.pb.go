...
type PluginServiceClient interface {
	...
	// validate plugin
	ValidatePlugin(ctx context.Context, in *ValidatePluginRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *pluginServiceClient) ValidatePlugin(ctx context.Context, in *ValidatePluginRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/plugin.PluginService/ValidatePlugin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PluginServiceServer interface {
	...
	// validate plugin
	ValidatePlugin(context.Context, *ValidatePluginRequest) (*emptypb.Empty, error)
...
func (UnimplementedPluginServiceServer) ValidatePlugin(context.Context, *ValidatePluginRequest) (*emptypb.Empty, error) {
...
func _PluginService_ValidatePlugin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/plugin.PluginService/ValidatePlugin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
