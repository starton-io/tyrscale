...
func NewServer(cfg *config.Schema, pluginStorage plugin.IPluginStorage, serviceManager plugin.IPluginManager) *Server {
...
func (s Server) Run() error {
	pluginGRPC.RegisterHandlers(s.engine, s.pluginStorage, s.serviceManager)
